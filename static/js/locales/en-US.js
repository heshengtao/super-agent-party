window.lang_enUS = {
    ...
    'Authorization': 'Bearer YOUR_API_KEY_HERE'
        ...
        'vendorParamDesc_orcarouter_reasoning': 'Unified reasoning control via OrcaRouter.',
      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'localAppControlDescription': 'Scan and control locally installed Electron apps via CDP debugging ports. Sorted by CDP compatibility: electron (full support) > browser > cef (partial) > chromium (may fail). If the desired application cannot be scanned, you can add it manually.',
        'scanLocalApps': 'Scan Local Apps',
        'manualAppPlaceholder': 'Enter app path…',
        'scanLocalAppsHint': 'Scanning may take some time. Not all detected apps support CDP remote debugging.',
...
Key3`,
        ...
        'thaNotice1':'THA table pet uses THA4 ONNX / CoreML models for AI rendering. Upload .onnx or .zip (mlpackage) files. To distill your own character model, visit <a href="https://github.com/heshengtao/talking-head-anime-4-demo" target="_blank">github.com/heshengtao/talking-head-anime-4-demo</a>. Use the AI Agent in this project for assisted deployment.',
        'dropTHAZipFile':'Click or drag .onnx / .zip file here',
        'THAPet': 'THA Table Pet Bot',
        'thaModel': 'THA Model',
        'SoulXFlashHead': 'SoulX Table Pet Bot',
        'soulxServiceNotice': 'Setup: go to <a href="https://github.com/heshengtao/SoulX-FlashHead" target="_blank">github.com/heshengtao/SoulX-FlashHead</a> and follow the README to deploy the backend. Use the AI Agent in this project or manually run <code>pip install -r requirements.txt</code> then <code>python streaming_server.py</code>. Default address: ws://127.0.0.1:8765. Once the server is running, return here and enable.',
        'soulxServerUrl': 'Server URL',
        'soulxWindowWidth': 'Window Width',
        'soulxWindowHeight': 'Window Height',
        'soulxTransparentBg': 'Transparent background',
        'soulxRefImage': 'Reference image (portrait photo)',
        'soulxNoImage': 'No reference image uploaded yet',
        'soulxSelectImage': 'Select reference image',
        'soulxUploadImage': 'Upload Reference Image',
        'soulxDropImage': 'Drag or click to select a front-facing portrait photo',
        'soulxImageNamePlaceholder': 'Persona name (for dropdown selection)',
        'soulxUpload': 'Upload',
        'startSoulxPet': 'Start SoulX Pet',
        'startSoulxPetWeb': 'Start in Browser',
        'stopSoulxPet': 'Stop SoulX Pet',
        'summonRealPersonCompanion': 'Summon Photorealistic Desktop Companion',
        'thaButton': 'THA Table Pet',
        'tha_distill_model': 'Distill your own THA4 model',
        'tha_distill_desc': 'Distill your own character THA4 ONNX model. Use the AI Agent in this project for assisted environment setup and training.',
