window.lang_zhCN = {
        ...
        'youcomTier': '使用层级',
        'youcomTierFree': '免费版（100次/天，无需API Key）',
        'youcomTierApiKey': 'API Key版（无限制，按量付费）',
        'youcomTierFreeNotice': '免费层级通过 MCP 端点查询，每天 100 次。部分网络环境（如中国大陆）可能无法访问此端点。',
    ...
    'Authorization': 'Bearer YOUR_API_KEY_HERE'
        'vendorParamDesc_deepseek_thinking': '启用推理模型的思考模式，与 reasoning_effort 配合使用。',
        'vendorParamDesc_zhipuai_thinking': '启用 GLM-4.5+ 推理模型的思考模式。',
        'vendorParamDesc_volcano_thinking': '启用推理模型的思考模式。',
        'vendorParamDesc_lingyi_thinking': '启用 Yi 推理模型的思考模式。',
        'vendorParamDesc_aliyun_enable_thinking': '开启/关闭 Qwen 混合思考模型的思维链。',
        'vendorParamDesc_aliyun_thinking_budget': '思维链最大 token 数（128-32768）。',
        'vendorParamDesc_siliconflow_enable_thinking': '开启/关闭推理模型的思考模式。支持 DeepSeek-R1、Qwen3 等。',
        'vendorParamDesc_siliconflow_thinking_budget': '思维链最大 token 数（128-32768）。',
        'vendorParamDesc_moonshot_enable_thinking': '开启/关闭 Kimi K2 思考模型的思维链。',
        'vendorParamDesc_moonshot_thinking_budget': '思维链最大 token 数。',
        'vendorParamDesc_qianfan_enable_thinking': '开启/关闭 ERNIE 推理模型的思考模式。',
        'vendorParamDesc_hunyuan_enable_thinking': '开启/关闭混元推理模型的思考模式。',
        'vendorParamDesc_baichuan_enable_thinking': '开启/关闭百川推理模型的思考模式。',
        'vendorParamDesc_stepfun_enable_thinking': '开启/关闭思考模式。',
        'vendorParamDesc_minimax_enable_thinking': '开启/关闭 MiniMax 推理模型的思考模式。',
        'vendorParamDesc_ollama_repeat_penalty': '重复惩罚系数，1.0 为禁用。',
        'vendorParamDesc_ollama_top_k': '仅保留概率最高的 K 个 token（0=禁用）。',
        'vendorParamDesc_ollama_mirostat': 'Mirostat 采样：0=关, 1=MIROSTAT, 2=MIROSTAT 2.0。',
        'vendorParamDesc_ollama_num_ctx': '上下文窗口大小（token 数）。',
        'vendorParamDesc_vllm_top_k': '仅保留概率最高的 K 个 token（-1=禁用）。',
        'vendorParamDesc_vllm_min_p': 'token 过滤的最小概率阈值。',
        'vendorParamDesc_vllm_repetition_penalty': '生成时的重复惩罚系数。',
        'vendorParamDesc_vllm_chat_template_kwargs': '控制 vLLM 上模型的思考模式（Qwen3/DeepSeek/Granite）。',
        'vendorParamDesc_sglang_top_k': '仅保留概率最高的 K 个 token（-1=禁用）。',
        'vendorParamDesc_sglang_min_p': '最小概率阈值。',
        'vendorParamDesc_sglang_repetition_penalty': '重复惩罚系数。',
        'vendorParamDesc_llama_cpp_repeat_penalty': '重复惩罚系数。',
        'vendorParamDesc_llama_cpp_top_k': 'Top-K 采样。',
        'vendorParamDesc_llama_cpp_mirostat': 'Mirostat：0=关, 1=MIROSTAT, 2=MIROSTAT 2.0。',
        'vendorParamDesc_lmstudio_top_k': '仅保留概率最高的 K 个 token。',
        'vendorParamDesc_lmstudio_min_p': '最小概率阈值。',
        'vendorParamDesc_xinference_top_k': '仅保留概率最高的 K 个 token。',
        'vendorParamDesc_xinference_repetition_penalty': '重复惩罚系数。',
        'vendorParamDesc_localai_top_k': '仅保留概率最高的 K 个 token。',
        'vendorParamDesc_localai_min_p': '最小概率阈值。',
        'vendorParamDesc_openrouter_reasoning': '统一推理控制参数。支持通过 OpenRouter 使用 Anthropic/Gemini/OpenAI。',
        'vendorParamDesc_openrouter_top_k': 'Top-K 采样。',
        'vendorParamDesc_orcarouter_reasoning': '统一推理控制参数（通过 OrcaRouter）。',
        'vendorParamDesc_perplexity_search_domain_filter': '限制搜索到指定域名，如 ["nature.com"]。',
        'vendorParamDesc_perplexity_search_recency_filter': '搜索结果时间过滤："day", "week", "month", "year"。',
        'vendorParamDesc_gemini_google': 'Gemini 思考配置（通过 liteLLM 时不需要此参数）。',
}`,
      'body': '请求体',
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'utilityTools': '实用工具',
        'images': '张图片',
        'stickerPackCreated': '表情包已创建',
        'createFailed': '创建失败',
        'stickerPackDeleted': '表情包已删除',
        'StickerPackManagement': '表情包管理',
        'noStickerPack': '暂无表情包',
        'goStickerPack': '前往添加表情包',
        ...
        'localAppControl': '本地应用控制',
        'localAppControlDescription': '扫描并控制本地安装的 Electron 应用，通过 CDP 调试端口进行操控。列表按 CDP 兼容性排序：electron（完全支持）> browser > cef（部分支持）> chromium（可能不支持）。如果扫描不到你要的应用，可以自行添加。',
        'scanLocalApps': '扫描本地应用',
        'manualAppPlaceholder': '输入应用路径…',
        'scanLocalAppsHint': '扫描可能需要十几秒，且并非所有扫描到的应用都支持 CDP 远程调试连接',
        'searchApps': '搜索应用...',
        'scanning': '扫描中...',
        'noLocalAppsFound': '未找到 Electron 应用',
        'appStatusRunning': '运行中',
        'appStatusStopped': '未运行',
        ...
        'cdpPort': 'CDP 端口',
        'connectedApps': '已连接应用',
        'scannedAppsCount': '已扫描',
        'appPages': '应用页面',
        'takeScreenshot': '截图',
        'takeSnapshot': '快照',
        'executeJS': '执行 JS',
        'success_scan_apps': '扫描完成，找到 {count} 个应用',
        'success_launch_app': '应用启动成功',
        'error_launch_app': '应用启动失败',
        'success_connect_app': '连接成功',
        'error_connect_app': '连接失败',
        'success_disconnect_app': '断开成功',
        'error_disconnect_app': '断开失败',
        'success_quit_app': '退出成功',
        'error_quit_app': '退出失败',
        'forceNewInstance': '开启新实例（独立用户数据）',
        'forceNewInstanceDesc': '开启后启动独立实例，关闭后复用已有实例（保留登录态和配置）',
...
key3`,
        ...
        'wslSandbox': 'WSL 沙箱',
        'wslSandboxPermission': 'WSL 沙箱权限',
        'wslSandboxNotice': '使用前请确保已开启 WSL2：以管理员身份运行 PowerShell，执行 "wsl --install" 或 "Enable-WindowsOptionalFeature -Online -FeatureName Microsoft-Windows-Subsystem-Linux"。安装完成后重启电脑。bubblewrap 沙盒工具将在首次使用时自动检测并安装。',
        ...
        'diaryAction_imMessage': '主动发消息',
        'diaryAction_browserControl': '浏览器控制',
        'diaryAction_smartHome': '智能家居控制',
        'diaryToolNotice': '联网搜索 / 知识库等动作仅允许 AI 使用只读低权限工具，不会执行电脑控制、代码或文件操作。',
        'diaryPushChannels': '推送渠道',
        'diaryImTargets': '主动发消息的渠道（随机选一个发送）',
        ...
        'diaryChatIntegration': '对话集成',
        'diaryChatIntegrationLabel': '将近期日记注入角色对话上下文',
        'diaryChatIntegrationMax': '参考最近 N 条日记',
        'diaryChatSummary': '聊天总结',
        'diaryChatSummaryLabel': '用户未对话超过 N 分钟后自动总结到日记',
        'diaryChatSummaryIdle': '空闲分钟数',
        'diaryAutoTool_webSearch': '联网搜索工具已被自动开启',
        'diaryAutoTool_knowledge': '知识库工具已被自动开启',
        'diaryAutoTool_browser': '浏览器控制工具（内建 CDP）已被自动开启',
        'diaryAutoTool_smartHome': '智能家居工具已被自动开启',
        'diaryAutoTool_smartHomeFail': '智能家居工具开启失败，请检查 HA 配置',
        'diaryAutoTool_noKb': '没有已配置的知识库，请先在知识库设置中添加',
        'diaryAutoTool_noHaKey': '未配置 Home Assistant API Key，请先在智能家居设置中填写',
        'diaryAutoTool_error': '开启对应工具失败',
        ...
        'cmd_plan_desc':'切换至计划模式（只读，仅允许分析规划）。需开启电脑命令行控制。',
        'cmd_read_desc':'切换至只读模式（可读取文件，不可修改）。需开启电脑命令行控制。',
        'cmd_edit_desc':'切换至编辑模式（可读取和修改文件）。需开启电脑命令行控制。',
        'cmd_yolo_desc':'切换至 Yolo 模式（拥有最高工具权限，静默执行）。需开启电脑命令行控制。',
        'cmd_cowork_desc':'切换至协作模式。需开启电脑命令行控制。',
        'cmd_goal_desc':'切换至目标模式。需开启电脑命令行控制。',
        'cmd_mode_need_cli':'请先在系统设置中开启电脑命令行控制功能。',
        'cmd_mode_switched':'已切换模式',
        ...
        'thaNotice1':'THA 桌面宠物使用 THA4 ONNX / CoreML 模型进行 AI 实时渲染，上传 .onnx 或 .zip (mlpackage) 文件即可。如需蒸馏自己的角色模型，前往 <a href="https://github.com/heshengtao/talking-head-anime-4-demo" target="_blank">github.com/heshengtao/talking-head-anime-4-demo</a>，可用本项目的 AI Agent 协助部署。',
        'dropTHAZipFile':'点击或拖放 .onnx / .zip 文件到此处',
        'THAPet': 'THA 桌宠机器人',
        'thaModel': 'THA 模型',
        'SoulXFlashHead': 'SoulX 桌宠机器人',
        'soulxServiceNotice': '部署说明：先前往 <a href="https://github.com/heshengtao/SoulX-FlashHead" target="_blank">github.com/heshengtao/SoulX-FlashHead</a> 按 README 部署后端服务。可用本项目的 AI Agent 或手动 pip install -r requirements.txt 后执行 python streaming_server.py 启动，默认监听 ws://127.0.0.1:8765。启动成功后返回此页面勾选启用即可。',
        'soulxServerUrl': '服务地址',
        'soulxWindowWidth': '窗口宽度',
        'soulxWindowHeight': '窗口高度',
        'soulxTransparentBg': '透明背景',
        'soulxRefImage': '参考图片（人物照片）',
        'soulxNoImage': '尚未上传参考图片',
        'soulxSelectImage': '选择参考图片',
        'soulxUploadImage': '上传参考图片',
        'soulxDropImage': '拖拽或点击选择一张人物正面照片',
        'soulxImageNamePlaceholder': '形象名称（用于下拉选择）',
        'soulxUpload': '上传',
        'startSoulxPet': '启动 SoulX 桌宠',
        'startSoulxPetWeb': '在浏览器启动',
        'stopSoulxPet': '停止 SoulX 桌宠',
        'summonRealPersonCompanion': '召唤写实风桌面伴侣',
        'thaButton': 'THA 桌宠',
        'tha_distill_model': '蒸馏个人THA4模型',
        'tha_distill_desc': '蒸馏你自己的角色 THA4 ONNX 模型，可用本项目的 AI Agent 协助部署环境和训练',
        ...
        'dataStoragePathHint': '选择一个文件夹，数据将存储在其中的 Super-Agent-Party 子目录下',
        'cloneFromRoot': '以当前（root）账户配置作为模板生成',
        'setAsDefaultAccount': '将此账户设为默认启动账户',
        'confirmCreate': '确认创建',
        'accountCreated': '新账户创建成功',
        'accountCreateFailed': '账户创建失败',
        'pleaseSelectDataPath': '请选择数据存储路径',
        'directoryNotEmpty': '目标目录不为空，请选择空文件夹或启用克隆模式',
        'noAccountsYet': '还没有创建任何账户',
        'accountElectronOnly': '账户管理仅在 Electron 桌面版中可用',
        'currentAccount': '当前',
        'defaultAccount': '默认',
        'createdAt': '创建于',
        'lastLaunched': '最后启动',
        ...
        'accountRenameFailed': '重命名失败',
        'deleteAccount': '删除账户',
        'deleteAccountConfirm': '确定要删除此账户吗？此操作不可撤销。',
        'keepDataFolder': '保留数据文件夹',
        'deleteDataFolder': '彻底删除数据文件夹',
        'confirmDelete': '确认删除',
        'accountDeleted': '账户已删除',
        'accountDeleteFailed': '账户删除失败',
        'launchAccount': '启动新实例',
        'switchAccount': '切换账户',
        'accountLaunching': '正在启动新实例...',
        'accountLaunchFailed': '启动失败',
        'accountSwitchFailed': '切换失败',
        'defaultAccountSet': '默认账户已设置',
        'defaultAccountSetFailed': '默认账户设置失败',
}
